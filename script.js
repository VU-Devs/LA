const links = {
	Essentials: [
		...
		{
			title: "VU Books",
			url: "https://www.vuboekhandel.nl/app/ds/dssufsea1.p?language=4&level=1&btnSearch=true&cboinsti=1",
		},
		{ title: "Timetable", url: "https://rooster.vu.nl/schedule" },
		{
			title: "Academic Calender",
			url: "https://vu.nl/en/education/more-about/academic-calendar",
		},
		{
			title: "Reserve a study spot",
	...
	"Lab Manuals / Course Sites": [
		{
			title: "Computer Networks (CN) Lab Manual",
			url: "https://computerscienceeducation.gitbook.io/computer-networks-lab-manual",
		},
		{
			title: "Computer Organisation (CO) Lab Manual",
			url: "https://computerscienceeducation.gitbook.io/co-lab-manual",
		},
		{ title: "Machine Learning (ML)", url: "https://mlvu.github.io/" },
		{ title: "Deep Learning (DP)", url: "https://dlvu.github.io/" },
		{
			title: "Systems Programming (SP) / CoPP (Computer Programming Project)",
			url: "https://vu-oofp.gitlab.io/website/",
		},
	...
	Onboarding: [
		...
		{
			title: "An INCREDIBLE guide to VUreaucracy",
			url: "https://docs.google.com/document/d/1tlq0PJ7KAgUN11uV7hgOcO0rMDJ_nasxr5bIWWgsNwM/edit?tab=t.0#heading=h.iq2z1epx4wdu",
		},
		{
			title: "Housing guide",
			url: "https://docs.google.com/document/d/1ozPf7sfI6Auh0GI2xT_g7csGCrKKj4tCFkUJP1WMfyI/edit?tab=t.0",
		},
		{
			title: "Unofficial Y1 TU Delft Incoming Guidance",
			url: "https://docs.google.com/document/d/1y9kRZ5H1UIEsEbEe1jOKZiS72GPqX-wa3Na4-3uMb4E/edit?tab=t.y13v59u66kpb#heading=h.cjd47meacr5n",
		},
		{
			title: "VU / CS / AMS Guide by Applesauce",
			url: "https://csdiscdocs.gitbook.io/vu-cs-amst-guide",
		},
		{
		...
		{
			title: "Bachelor Introduction Days",
			url: "https://vu.nl/en/education/more-about/get-your-studies-off-to-a-great-start-by-joining-the-vu-introduction-days",
		},
		{
			title: "VU Bookstore (Reading list)",
			url: "https://www.vuboekhandel.nl/app/stuver.p?language=4",
		},
		{
			title: "Tutiton Fees",
			url: "https://vu.nl/en/education/more-about/payment-of-tuition-fees-at-vu-amsterdam",
		},
	],

	"GitHub / GitLab / Orgs": [
		{
			title: "AtLarge CO/CN Github",
			url: "https://github.com/ComputerScienceEducation",
		},
		{ title: "VU IVM Github", url: "https://github.com/VU-IVM" },
		{
			title: "Machine Learning @ VU (MLVU) Github",
			url: "https://github.com/mlvu",
		},
		{ title: "Deep Learning @ (DLVU) VU", url: "https://github.com/dlvu" },
		{
			title: "VU Programming Github",
			url: "https://github.com/VU-Programming",
		},
		{ title: "VU StudSec Github", url: "https://github.com/StudSec/" },
		{
			title: "VU High Performance Distributed Computing (HPDC)",
			url: "https://www.vuhpdc.net/",
		},
		{ title: "VU Studsec (Student Security)", url: "https://studsec.nl/" },
		{
			title: "VU Sec (Systems and Network Security Group)",
			url: "https://www.vusec.net/",
		},
		{
			title:
				"CoPP (Computer Programming Project) and OOFP (Object-oriented and Functional programming)",
			url: "https://gitlab.com/vu-oofp",
		},
		{
			title: "VU Software Design",
			url: "https://github.com/VU-SoftwareDesign",
		},
		{
			title: "University Library Vrije Universiteit Amsterdam",
			url: "https://github.com/ubvu",
		},
		{
			title: "Systems Biology Lab, Vrije Universiteit Amsterdam",
		...
		{
			title: "Intelligent Systems course",
			url: "https://github.com/intelligent-systems-course",
		},
		{
			title: "VU Autonomous Systems Engineering",
			url: "https://github.com/VU-ASE",
		},
	...
	"Socials / Groups": [
		...
		{
			title: "2025 CS Whatssap Group",
			url: "https://chat.whatsapp.com/HfHTgsechBVCP0xEO1Ez8g",
		},
		{
			title: "2025 Math Whatssap Group",
			url: "https://chat.whatsapp.com/LliWar4bTzIGwfqYqrLDls",
		},
		{ title: "SRVU Studentenbond", url: "https://srvu.org/en/homepage/" },
		{
			title: "Icarus (Philosophy Student Club)",
			url: "https://www.instagram.com/vu.icarus/",
		},
		{ title: "VU Pride", url: "https://linktr.ee/VUpride" },
		{
			title: "Neurodiverse Student Association (NDSA)",
			url: "https://linktr.ee/nd.sa",
		},
		{
			title: "Boosted Griffins (Gaming Group)",
			url: "https://www.instagram.com/boostedgryffins/",
		},
	...
	Lectures: [
		...
		{
			title: "Networks and Graphs Lectures",
		...
		},
		{
			...
			url: "https://www.youtube.com/playlist?list=PLbsY-4I8oat9o7p4re3308L4uk0YJe8ez",
		},
		{
			title: "[External Category Theory]",
			url: "https://www.youtube.com/playlist?app=desktop&list=PLbgaMIhjbmEnaH_LTkxLI7FMa2HsnawM_",
		},
		{
			title: "[External] Linear Algebra Organic Chem Tutor",
			url: "https://www.youtube.com/playlist?list=PLDDGPdw7e6AjJacaEe9awozSaOou-NIx_",
		},
		{
			title: "[External] Linear Algebra Trev Tutor",
			url: "https://www.youtube.com/playlist?list=PLDDGPdw7e6AjJacaEe9awozSaOou-NIx_",
		},
		{
			title: "[External] Intro to x86 Assembly",
			url: "https://youtube.com/playlist?list=PLmxT2pVYo5LB5EzTPZGfFN0c2GDiSXgQe",
		},
	],
	...
	Notes: [
		{
			...
			url: "https://lectures.alex.balgavy.eu/",
		},
	],
	...
	Archived: [
		...
		{
			title: "Object Oriented Functional Programming (OOFP) Kickoff",
			url: "https://docs.google.com/presentation/d/1fPS0RPnBqtMI9V6HB5G6yh0KsiyCC9kWCKRe8b-500U/edit?slide=id.g2fad02caa80_45_0#slide=id.g2fad02caa80_45_0",
		},
		{
			title: "Computer Networks (CN) 2023-2024",
			url: "https://computer-networks-lab.gitbook.io/computer-networks-lab-manual/assignments/dns",
		},
		{
			title: "Department of Computer Science Website (For historical purposes)",
			url: "https://www.cs.vu.nl/~ast/",
		},
		{
			title: "Virtual Laboratory for e-Science",
			url: "http://www.vl-e.nl/frame_home.htm",
		},
	],
	...
	Misc: [
		...
		{
			title: "Theft Infographic",
			url: "https://assets-us-01.kc-usercontent.com/d8b6f1f5-816c-005b-1dc1-e363dd7ce9a5/4a68800b-0674-4e82-bcd5-0d6853129e9f/Folder_Diefstal_ENG_tcm270-868120.pdf",
		},
		{ title: "VU Events", url: "https://vu.nl/en/events" },
		{
			title: "Library Availability",
			url: "https://vu-amsterdam.im-motion.net/",
		},
		{
			title: "VU Thesis Search",
			url: "https://vu.nl/en/about-vu/divisions/university-library/more-about/uploading-your-thesis",
		},
		{
		...
		{
			title: "German Collegiate Programming Contest 2025",
			url: "https://gcpc.nwerc.eu",
		},
		{
...
document
	...
	.addEventListener("input", (e) => renderAll(e.target.value.toLowerCase()));
